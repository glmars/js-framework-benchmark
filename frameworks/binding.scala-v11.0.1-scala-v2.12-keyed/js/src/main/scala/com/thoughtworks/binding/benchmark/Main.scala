...
object Main extends scalajs.js.JSApp {
  ...
  @dom def render(store: Store) = <div class="container">
    <div class="jumbotron">
      <div class="row">
        <div class="col-md-6">
          <h1>Binding.scala v11.0.1 Scala v2.12</h1>
        </div>
        <div class="col-md-6">
          <div class="row">
